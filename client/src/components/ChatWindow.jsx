...
const ChatWindow = ({
  ...
  useEffect(() => {
    ...
    // Join only this exact channel + contact.
    joinChat(
      chat.jid,
      chat.channelId
    );
    ...
    setMessages(
      (previous) => {
        ...
        for (const msg of incoming) {
          ...
          /*
           * Replace the temporary optimistic
           * outgoing message when the real
           * Baileys message arrives.
           */
